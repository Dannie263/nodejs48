...
SELECT * FROM product
SELECT produc_name, image FROM product
...
-- dấu * lấy hết tất cả column trong table đó
...
--Cách 2: dùng keyword MAX + query lồng
SELECT * FROM users 
WHERE age = (
...
-- soft delete
-- is_delete hoặc deleted_ad để show hoặc hidden
-- data
SELECT * FROM users
